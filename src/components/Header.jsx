  ...
  return (
    <motion.div className='flex flex-col justify-center items-center text-center my-20'
     ...
     >
        ...
        >Unleash your creativity with AI. Turn your imagiination into visual art in seconds - just type, and watch the magic happen.</motion.p>
        ...
        initial={{opacity:0}}
        animate={{opacity:1}}
        transition={{default:{duration:1},opacity:{delay:0.8,duration:1}}}
